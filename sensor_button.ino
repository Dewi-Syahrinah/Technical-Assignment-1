...
const char* serverName = "http://192.168.137.1:5000/button/data";


// Pin untuk sensor button
const int SensorPin = 33; // GPIO35 (ADC1)

// Ambang batas untuk mendeteksi keberadaan buah
const int threshold = 1000; // Sesuaikan ambang batas ini berdasarkan pengujian sensor Anda
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) { // Cek koneksi WiFi
    ...
    // Membaca nilai dari sensor button
